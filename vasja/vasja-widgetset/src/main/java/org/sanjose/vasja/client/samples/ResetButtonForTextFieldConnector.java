package org.sanjose.vasja.client.samples;
...
import org.sanjose.vasja.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.sanjose.vasja.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
